''' Класс DictMixin представляет собой миксин, который добавляет в класс, наследующий его, метод to_dict(). Этот метод позволяет преобразовать объект в словарь.

Внутри класса DictMixin вы можете создавать сколько угодно служебных методов и атрибутов, которые помогут вам справиться с задачей. Главное, это реализовать метод to_dict(), он являться точкой входа для взаимодействия с вашим миксином и он должен вернуть представление вашего объекта в виде словаря. Обратите внимание на вложенность атрибутов. '''
