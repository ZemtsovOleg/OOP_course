...
class Wallet:
    ...
    def __init__(self, currency: str, balance: int) -> None:
    ...
    def __add__(self, value: object) -> object:
        if isinstance(value, Wallet) and self.currency == value.currency:
...
wallet8 = wallet2 - wallet3
print(wallet8.currency, wallet8.balance)
